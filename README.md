...
**Это первая версия приложения, собранная с помощью большого количества useState и неоптимизированным алгоритмом сортировки. Сейчас я работаю над оптимизацией.**